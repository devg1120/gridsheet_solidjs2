...
describe("IndexFunction", () => {
    ...
    const createTestTable = (
        area: AreaType = { top: 1, left: 2, bottom: 5, right: 3 },
    ) => {
    ...
    describe("validation", () => {
        it("should throw error for incorrect number of arguments", () => {
            ...
            expect(() => indexFunction([]).call()).toThrow(
                "Number of arguments for INDEX is incorrect.",
            );

            expect(() => indexFunction([1, 2, 3, 4]).call()).toThrow(FormulaError);
            expect(() => indexFunction([1, 2, 3, 4]).call()).toThrow(
                "Number of arguments for INDEX is incorrect.",
            );
        });
        ...
        it("should throw error for invalid first argument", () => {
            ...
            expect(() => indexFunction(["not a table"]).call()).toThrow(
                "First argument must be a range.",
            );

            expect(() => indexFunction([[1, 2, 3]]).call()).toThrow(FormulaError);
            expect(() => indexFunction([[1, 2, 3]]).call()).toThrow(
                "First argument must be a range.",
            );
        });
        ...
        it("should throw error for invalid row number", () => {
            ...
            expect(() => indexFunction([table, -1]).call()).toThrow(
                "Row number must be greater than or equal to 0.",
            );
        });
        ...
        it("should throw error for invalid column number", () => {
            ...
            expect(() => indexFunction([table, 1, -1]).call()).toThrow(
    ...
    describe("edge cases", () => {
        it("should throw error for out-of-range row", () => {
            ...
            expect(() => indexFunction([table, 6]).call()).toThrow(
                "Row number 6 is out of range.",
            );
        });
        ...
        it("should throw error for out-of-range column", () => {
            ...
            expect(() => indexFunction([table, 1, 4]).call()).toThrow(
                "Column number 4 is out of range.",
            );
        });
    });
});
