...
import { clear, escape, select, setEditingAddress, undo, redo, arrow, walk, write, copy, cut, paste, setSearchQuery, setEntering, setInputting, updateTable } from "../store/actions";
            ...
            {lexer.tokens.map((token, i) => {
                ...
                if (token.type === "REF" || token.type === "RANGE") {
                    ...
                    return (
                        <TokenSpan
                            ...
                            tokenKey={tokenKey}
                            color={color}
                            class={`gs-token-type-${token.type}`}
                        />
                    );
                }
                ...
                return (
                    <TokenSpan
                        token={token}
                        tokenKey={tokenKey}
                        class={`gs-token-type-${token.type} gs-token-entity-type-${typeof token.entity}`}
                    />
                );
            })}
        </>
