                   ...
                   <Panel id="1" onResize={(size) => v_resize("1", size)}>
                      <PanelGroup>
                        <Panel id="11" onResize={(size) => h_resize("11", size)}>
                            <Tabular sheetWidth={400} sheetHeight={200} gsid={gsid+"-A"}  />
			</Panel>
                        <ResizeHandle />
                        <Panel id="12" onResize={(size) => h_resize("12", size)}>
                            <Tabular sheetWidth={400} sheetHeight={200} gsid={gsid+"-B"}  />
			</Panel>
                      </PanelGroup>
                   </Panel>
                <ResizeHandle />
                   <Panel id="2" onResize={(size) => v_resize("2", size)}>
                      <PanelGroup>
                        <Panel id="21" onResize={(size) => h_resize("21", size)}>
                            <Tabular sheetWidth={400} sheetHeight={200} gsid={gsid+"-C"}  />
			</Panel>
                        <ResizeHandle />
                        <Panel id="22" onResize={(size) => h_resize("22", size)}>
                            <Tabular sheetWidth={400} sheetHeight={200} gsid={gsid+"-D"}  />
			</Panel>
                      </PanelGroup>
                   </Panel>
              </PanelGroup>
