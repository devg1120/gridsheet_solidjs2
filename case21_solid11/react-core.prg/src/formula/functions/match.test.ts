...
describe("MatchFunction", () => {
    ...
    describe("validation", () => {
        ...
        it("should throw error for invalid search type", () => {
            ...
            const match = new MatchFunction({
                args: [
                    new ValueEntity("value"),
                    new RangeEntity("A1:C1"),
                    new ValueEntity(2),
                ],
                table,
            });
    ...
    describe("exact match (search_type = 0)", () => {
        ...
        it("should find exact match in multi-row table", () => {
            ...
            const match = new MatchFunction({
                args: [
                    new ValueEntity("date"),
                    new RangeEntity("A1:B2"),
                    new ValueEntity(0),
                ],
                table,
            });
        ...
        it("should throw error when no exact match found", () => {
            ...
            const match = new MatchFunction({
                args: [
                    new ValueEntity("cherry"),
                    new RangeEntity("A1:B1"),
                    new ValueEntity(0),
                ],
                table,
            });
